...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "I am Muthu Palaniappan M";

  strs[1][0] = "I'm a Computer Science Major";
  strs[1][1] = "at Shiv Nadar University at Chennai in India.";

  strs[2][0] = "I've been teaching myself how to code for 3 years!";
  strs[2][1] = "Machine Learning and Story Telling with Data.";

  strs[3][0] = "Reach Me";
  strs[3][1] = "muthu21110142@snuchennai.edu.in";
